...
The development of htrun has been moved into the [mbed-tools](https://github.com/armmbed/mbed-tools) repository. You can continue to use this module for legacy reasons, however all further development should be continued in the new repository.
